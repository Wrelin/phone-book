...
const (
	...
	Random_GetSum_FullMethodName        = "/Random/GetSum"
)
...
type RandomClient interface {
	...
	GetSum(ctx context.Context, in *RequestSum, opts ...grpc.CallOption) (*ResponseSum, error)
}
...
func (c *randomClient) GetSum(ctx context.Context, in *RequestSum, opts ...grpc.CallOption) (*ResponseSum, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseSum)
	err := c.cc.Invoke(ctx, Random_GetSum_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RandomServer interface {
	...
	GetSum(context.Context, *RequestSum) (*ResponseSum, error)
...
func (UnimplementedRandomServer) GetSum(context.Context, *RequestSum) (*ResponseSum, error) {
...
func _Random_GetSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Random_GetSum_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RandomServer).GetSum(ctx, req.(*RequestSum))
	}
	return interceptor(ctx, in, info, handler)
}
