...
// CSV_FILE resides in the home directory of the current user
...
func insert(pS *Entry) error {
	...
	_, ok := index[pS.LastAccess]
	if ok {
		return fmt.Errorf("%s already exists", pS.LastAccess)
	}
	data = append(data, *pS)
	// Update the index
	_ = createIndex()
